...
-- 99%+ of other users will be in a particular user's extended social network.
-- The average degree of separation between a user and those in her extended network is usually 4 or 5.
